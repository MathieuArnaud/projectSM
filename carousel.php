...
<div id="carousel">
    ...
    <div id="c0" class="cCenter">
        ...
        <p class="describCar">
        Avec une capacité de charge utile de 3 500 livres et une suspension pneumatique ajustable, le Cybertruck est l'outil le plus puissant que nous ayons jamais conçu. Il est doté d'un espace de rangement verrouillable de 100 pieds cubes à l'extérieur, y compris un couvre benne suffisamment résistant pour se tenir debout dessus.
        </p>
    </div>
    <div id="c1" class="cRight">
        <img src="" class="imgCar">
        <span>STOCKAGE SÉCURISÉ</span></br>
        <p class="describCar">
    ...
    <div id="c3" class="cNone">
        <img src="" class="imgCar">
        <span>SUSPENSION PNEUMATIQUE ADAPTATIVE</span></br>
        <p class="describCar">
    ...
    <div id="c4" class="cNone">
        <img src="" class="imgCar">
        <span>INTÉRIEUR MODULABLE</span></br>
        <p class="describCar">
    ...
    <div id="c5" class="cLeft">
        <img src="" class="imgCar">
        <span>Excellente capacité d'adaptation</span></br>
        <p class="describCar">
